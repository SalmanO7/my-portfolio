        ...
        <div className="contact-content">
          ...
          <div className="contact-info">
            <div className="contact-card">
              ...
              <span className="contact-card-data">itechmohsin310@gmail.com</span>
              <a
                href="https://mail.google.com/mail/u/0/#sent?compose=DmwnWrRlQhdLPXMPnpSklTcqkfrXGfxWCLZwmxFBRLXRbBFJHCMJZbkbTJtPWJxDdPqsMwgmGJcg"
            ...
            <div className="contact-card">
              ...
              <span className="contact-card-data">+92 317 1442824</span>
            ...
            <div className="contact-card">
              ...
              <span className="contact-card-data">m.mohsin</span>
              <a
                href=" https://www.facebook.com/profile.php?id=100040576321721"
                className="contact-btn"
              >
                Write me <GoArrowRight className="contact-button-icon" />
              </a>
